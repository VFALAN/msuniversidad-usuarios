...
public class PageUtils {
    ...
    public static UsuarioTableDTO fromTuple(Tuple t) {
        return UsuarioTableDTO.builder()
                ...
                .aPaterno(t.get(UsuarioConstants.APELLIDO_PATERNO) != null ? (String) t.get(UsuarioConstants.APELLIDO_PATERNO) : null)
                .aMaterno(t.get(UsuarioConstants.APELLIDO_MATERNO) != null ? (String) t.get(UsuarioConstants.APELLIDO_MATERNO) : null)
                .indActivo(t.get(GenericConstans.IND_ACTIVO) != null ? (Boolean) t.get(GenericConstans.IND_ACTIVO) : false)
                .idEstatus(t.get(EstatusConstans.ID_ESTATUS) != null ? (String) t.get(EstatusConstans.ID_ESTATUS) : null)
                .idPerfil(t.get(PerfilConstans.ID_PERFIL) != null ? (String) t.get(PerfilConstans.ID_PERFIL) : null)
